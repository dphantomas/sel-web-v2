  ...
  return (
    <>
      ...
      <aside
        ...
        className="hidden md:flex flex-col bg-white border-r border-sel-lavender/30 font-sans text-sel-body"
      >
        <div className="h-16 flex items-center px-6 border-b border-sel-lavender/30 flex-shrink-0">
        ...
        <nav className="flex-1 py-6 px-4 space-y-1 overflow-y-auto">
          ...
          <div className="my-2 border-b border-sel-lavender/30"></div>
        ...
        <div className="p-4 border-t border-sel-lavender/30 flex-shrink-0">
      ...
      <main
        ...
        className="bg-sel-cream font-sans text-sel-body"
      >
        <header className="h-16 bg-white border-b border-sel-lavender/30 flex items-center justify-between px-8 md:hidden flex-shrink-0">
